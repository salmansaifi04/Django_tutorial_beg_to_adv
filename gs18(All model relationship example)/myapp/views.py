...
def show_user_data(request):
    ...
    data4 = User.objects.filter(post__post_publish_date='2022-08-05')
...
def show_page_data(request):
    ...
    data3 = Page.objects.filter(user__email='admin@gmail.com')
...
def show_post_data(request):
    ...
    data2 = Post.objects.filter(post_publish_date = '2022-08-05')
    data3 = Post.objects.filter(user__username='salman')
...
def show_song_data(request):
    ...
    data3 = Song.objects.filter(user__username='salman')
